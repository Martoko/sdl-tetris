...
void TetrisGame::propagateEvents() {
    SDL_Event event;
...
void TetrisGame::onKeyDown(SDL_KeyboardEvent event) {
    if (game_over) {
...
void TetrisGame::onKeyUp(SDL_KeyboardEvent event) {
    if (game_over) {
        return;
    }
 ...
 */
bool TetrisGame::tryApplyGravity() {
...
bool TetrisGame::move(Tetromino *tetromino, int dx, int dy) {
...
void TetrisGame::rotate(Tetromino *tetromino, int amount) {
...
bool TetrisGame::tryRotate(Tetromino *tetromino, int amount) {
